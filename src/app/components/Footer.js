      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div className="md:col-span-2">
              ...
              <p className="text-slate-300 leading-relaxed mb-6 max-w-md">
                ...
                digital experiences. Always learning, always creating.
              </p>
        ...
        <div className="border-t border-slate-800 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="text-slate-400 text-sm mb-4 md:mb-0">
              <p>
                © {currentYear} Rhythm. All rights reserved. Built with ❤️ using{' '}
                <a 
            ...
            <div className="flex items-center space-x-4">
              <span className="text-slate-400 text-sm">
                Made with passion in {currentYear}
              </span>
              <button
                onClick={scrollToTop}
                className="bg-slate-800 hover:bg-blue-600 text-slate-400 hover:text-white p-2 rounded-lg transition-all duration-300 hover:scale-110"
        ...
        <div className="text-center py-4 border-t border-slate-800">
          <p className="text-slate-500 text-xs">
            🚀 This portfolio was coded with lots of ☕ and 🎵
          </p>
        </div>
      </div>
    </footer>
